...
-- CASCADE: policies criadas em runs anteriores deste script dependem
-- desta funcao. Sem CASCADE, o DROP falha com 2BP01.
...
DROP FUNCTION IF EXISTS public.check_api_rate_limit(text, text, integer, integer) CASCADE;
