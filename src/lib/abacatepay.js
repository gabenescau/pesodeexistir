...
export const PLANS = {
  ...
  annual: {
    ...
    benefits: [
      ...
      { text: "Atualizações constantes" },
      { text: "Acesso em todos os dispositivos" },
      { text: "Selo de verificado no perfil", icon: "verified", annualOnly: true },
      { text: "Destaque no Instagram do OPE Club", icon: "instagram", annualOnly: true },
      { text: "Acesso antecipado a lancamentos exclusivos", annualOnly: true },
      { text: "Conteudo premium so para membros anuais", annualOnly: true },
      { text: "Convite para eventos e encontros com a comunidade", annualOnly: true },
      { text: "Suporte prioritario", annualOnly: true },
    ],
  },
};
